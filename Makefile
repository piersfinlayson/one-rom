...
.PHONY: all clean clean-firmware clean-firmware-build clean-sdrr-info sdrr-info info info-detail firmware run flash test test-pio generated clean-generated
...
test-pio: firmware
	...
	@echo "-----"
	@GEN_OUTPUT_DIR=$(GEN_OUTPUT_DIR) EXTRA_C_FLAGS="$(EXTRA_C_FLAGS)" make --no-print-directory -C $(FIRMWARE_DIR) -f test.mk
	@echo "-----"
	@echo "Tests completed"
