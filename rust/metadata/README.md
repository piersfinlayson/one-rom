...
The metadata schema for this crate lives in [metadata_schema.toml](/rust/metadata/metadata_schema.toml). This crate's build script passes it to [onerom-metadata-gen](/rust/metadata-gen), which generates the C headers and the Rust source.
