...
pub struct ProgramArgs {
    ...
    #[arg(
        ...
        value_name = "FILE",
        conflicts_with_all = ["slot", "config_name", "config_description", "save_config", "no_config", "firmware", "instance_name", "serial_override", "logging", "disable_swd", "turbo_boot"]
    )]
    ...
    #[arg(long, visible_aliases = ["swd-disable", "swd_disable"], conflicts_with_all = ["no_config", "config_file"])]
